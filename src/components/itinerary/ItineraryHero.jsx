...
import { ITINERARY_HERO } from "../../data/itinerary";
...
export default function ItineraryHero() {
  const { image, imageSmall, kicker, headline, subline } = ITINERARY_HERO;

  return (
    <section className="relative h-[86vh] min-h-[560px] w-full overflow-hidden flex items-end">
      <div className="absolute inset-0 bg-obsidian-soft">
        <img
          src={image}
          srcSet={`${imageSmall} 900w, ${image} 2000w`}
          sizes="100vw"
          alt="Mist rolling over a green highland valley at dawn"
          loading="eager"
          fetchPriority="high"
          decoding="async"
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, rgba(15,15,16,0.72) 0%, rgba(15,15,16,0.25) 35%, rgba(15,15,16,0.55) 70%, rgba(15,15,16,0.97) 100%)",
        }}
      />
